package com.produtos.api.domains.message;

public class ProductMessage {

    public static final String PRODUCT_NOT_FOUND_ID_MESSAGE = "Não foi possivel encontrar nenhum produto com esse {idProduct} :( ";

    public static final String PRODUCT_FOUND_SKU_MESSAGE = "Produto com esse {sku} já existe :(";
